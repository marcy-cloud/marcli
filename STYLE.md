...
* **IMPORTANT** ✨: After every time you touch the code, you MUST run `go run main.go build` to verify it compiles! We're so organized and we don't want broken code! 💖
